...
constructor(props){
    ...
    this.state = {
      ...
      console.log(this.state.managerId," ***** ",this.state.memberId," ***** ",this.state.pastReportId)
      console.log("is reply or new message",this.state.isReply)
}
  ...
  sendReply = async () => {
    ...
    const { managerId,memberId,reportId,reportText,pastReportId } = this.state
      console.log(managerId," *** ",memberId," *** ",reportId," *** ",reportText," *** ",pastReportId)
      if (managerId) {
        if (memberId) {
          if (reportId) {
              if(reportText){
